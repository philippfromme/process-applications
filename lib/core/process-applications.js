...
export default class ProcessApplications extends EventEmitter {
  ...
  /**
   * Find process application resource (BPMN, DMN or Form)
   *
   * @param { {
   *   id: string,
   *   type: string,
   ...
   */
  findResource(ref) {
    return this._references.findResource(ref);
  }

  /**
   * Find references to process application resource (BPMN, DMN or Form)
   *
   * @param { {
   *   id: string,
   *   type: string,
  ...
  /**
   * Get completion suggestions for reference.
   *
   * @param { {
   *   value: string,
   *   type: string,
